<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    @elseif (Auth::user()->role->nombre == "Cocinero")
                        <a href="{{ route('cocinero.index') }}">
                            <x-application-logo class="block h-9 w-auto fill-current text-gray-800" />
                        </a>
                    @else
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @elseif (Auth::user()->role->nombre == "Cocinero")
                        <x-nav-link :href="route('cocinero.index')" :active="request()->routeIs('cocinero.index')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route(strtolower(Auth::user()->role->nombre) . '.index')" :active="request()->routeIs('/')">
                {{ __('Inicio') }}
