        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <br><br>
                    <p>En esta sección como usuario puedes agregar la reservas para el local entero</p>
                    <br>
                    <form action="{{ url('/usuario/reservaLocal/store') }}" class="space-y-1" method="POST" enctype="multipart/form-data">
                    @csrf
