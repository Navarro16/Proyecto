        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    {{ __("Gestión para la reserva del local") }}
                    <br><br>
                    <div class="flex justify-center items-center place-content-center">
                        <button class="button-create w-64">
                            <a href="{{ url('/administrador/reservaLocal/create') }}">Crear reserva del local</a>
                        </button>
                    </div>
                    <br><br>
                    <div class="flex justify-center items-center place-content-center">
                        <table table class="table-cocinero border-collapse border-spacing-2 border border-500 ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border border-slate-600">Nombre del cliente</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border border-slate-700">
                                        <a href="{{ url('administrador/reservaLocal/'.$reserva -> id.'/edit') }}">
                                            <button type="button" class="button-update">Modificar</button>
                                        </a>
                                        <form action="{{url('administrador/reservaLocal/'. $reserva->id.'/destroy')}}" method="POST">
                                            @csrf    
                                            @method('DELETE')                                            
